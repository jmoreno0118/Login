package com.ejemplo.myapplication9.app;
...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try{
            ...
            if(textoMemoria.equals("Loggedin")){
